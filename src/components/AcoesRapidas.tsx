...
export function AcoesRapidas({ onAgendar }: Props) {
  ...
  return (
    <div className="acoes-rapidas">
      <a
        ...
        className="acao-btn acao-whatsapp"
        title="WhatsApp"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="acao-btn acao-instagram"
        title="Instagram"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="acao-btn acao-maps"
        title="Google Maps"
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="white"><path d="M12 0C7.58 0 4 3.58 4 8c0 5.4 7 14 8 14s8-8.6 8-14c0-4.42-3.58-8-8-8zm0 11.5c-1.93 0-3.5-1.57-3.5-3.5S10.07 4.5 12 4.5s3.5 1.57 3.5 3.5S13.93 11.5 12 11.5z"/></svg>
      </a>
      <button className="acao-btn acao-agendar" title="Agendar" onClick={onAgendar}>
